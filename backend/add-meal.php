...
<html lang="en">
    <head>
        ...
        <title>Meal Manageent System</title>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Begin Page Content -->
                    <div class="add_meal_area">
                        <div class="container-fluid">
                            <!-- Page Heading -->
                            <div class="add_meal_area_box">
                                <div class="add_meal_header">
                                    <div>
                                        <p>
                                    ...
                                    <a href="#"
                                        ><i class="fas fa-list"></i>Meal List</a
                                    >
                                </div>
                                <div class="add_meal_table">
                                    <form action="">
                                        <table>
                                            <tr>
                                                <th>si</th>
