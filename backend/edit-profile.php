...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span><i class="fas fa-plus-circle mr-1"></i>
            Edit Profile
            </span>
            <small class="d-sm-block"><a href="profile.php" class="btn btn-success btn-sm"><i class="fas fa-list mr-1"></i>View Profile</a></small>
        </div>
        <div class="card-body">
            <form action="action/profile/update.php" method="post">
                <div class="container">
                    <div class="row">
                        <?php
