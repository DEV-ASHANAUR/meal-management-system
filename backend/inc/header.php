            ...
            >
                ...
                <li class="nav-item">
                    <a
                        ...
                        data-target="#collapseMess"
                        aria-expanded="true"
                        aria-controls="collapseMess"
                    >
                ...
                <li class="nav-item">
                    ...
                    >
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="bazer-cost.php"
                                >Bazer Cost</a
                            >
                            <a
                                class="collapse-item"
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="#"
                        data-toggle="collapse"
                        data-target="#collapsePresentMonth"
                        aria-expanded="true"
                        aria-controls="collapsePresentMonth"
                    >
                        <i class="fas fa-fw fa-cog"></i>
                        <span>Present Month</span>
                    </a>
                    <div
                        id="collapsePresentMonth"
                        class="collapse"
                        aria-labelledby="headingUtilities"
                        data-parent="#accordionSidebar"
                    >
                ...
                <li class="nav-item">
                    <a
                        ...
                        href="#"
                        data-toggle="collapse"
                        data-target="#collapsePrevMonth"
                        aria-expanded="true"
                        aria-controls="collapsePrevMonth"
                    >
                        <i class="fas fa-fw fa-cog"></i>
                        <span>Previous Month</span>
                    </a>
                    <div
                        id="collapsePrevMonth"
                        class="collapse"
                        aria-labelledby="headingUtilities"
                        data-parent="#accordionSidebar"
                    >
